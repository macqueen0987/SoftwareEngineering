...
class Game {
    ...
    public int winnerCheck(){
        for(int i = 0; i < players.length; i++) {
            if(players[i].getPieceCount() == 0){ return i; }
        }
        return -1;
    }
...
public class Main {
    public static void main(String[] args) {
        Scanner scanner = new Scanner(System.in);
        System.out.println("Enter the board detail");
        System.out.print("shape(square = 4, pentagon = 5 ...) : ");
        int polygon = Integer.parseInt(scanner.nextLine());
        System.out.print("Enter the number of players : ");
        int playerNum = Integer.parseInt(scanner.nextLine());
        System.out.print("Enter the number of pieces : ");
        int pieceNum = Integer.parseInt(scanner.nextLine());
        Game game = new Game(playerNum, pieceNum, polygon);
        game.play();
    }
}
