...
public final class BoardGeometry {
    ...
    private static final Point[] RAW = {
        ...
        /* 대각 (우상→중앙) */ new Point(420,180), new Point(360,240), new Point(300,300), //20-22
        /* 대각 (우하→중앙) */ new Point(360,360), new Point(420,420), //23-24
        /* 대각 (좌상→중앙) */ new Point(180,180), new Point(240,240), //25-26
        /* 대각 (좌하→중앙) */ new Point(240,360), new Point(180,420)   //27-28
    };
